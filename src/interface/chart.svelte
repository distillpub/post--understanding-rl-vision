<script>
  ...
  export let height;
  export let width;
  export let bar_width_frac = 0.3;
  export let quantile_to_overflow = 0.9;
  export let max_overflow = 5;
  export let fixed_upper_value = null;
  export let fixed_lower_value = null;
  export let ticks_width_frac = 0.02;
  export let ticks_count = 5;
  export let ticks_overlapped = true;
  ...
  $: upper_value = (function() {
    if (fixed_upper_value === null) {
      ...
      return fixed_upper_value;
    }
  })();
  $: lower_value = (function () {
    if (fixed_lower_value === null) {
      if (values === null) {
        return null;
      }
      else {
